...
PROD_ACCOUNT_IDS = {'11111111111111', '112233445566', '111122223333'}
SG_CHANGE_EVENTS = {
    'CreateSecurityGroup': {
        'fields': ['groupName', 'vpcId'],
        'title':
            'User [{actor}] has manually created security group [{groupName}]',
    },
    'AuthorizeSecurityGroupIngress': {
        'fields': ['groupId'],
        'title':
            'User [{actor}] has manually updated security group [{groupId}]',
    },
